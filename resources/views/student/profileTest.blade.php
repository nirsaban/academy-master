...
$years = [2020,2019,2018,2017,2016,2015,2014,2013,2012,2011,2010,2009,2008,2007,2006,2005,2004,2003,2002,2001,2000,1999,1998,1997,1996,1995,1994,1993,1992,1991,1990,1989,1988,1987,1986,1985,1984,1983,1982,1981,1980,1979,1978,1977,1976,1975,1974,1973,1972,1971,1970];
       ...
       <div>
             ...
             <div class="tab-pane fade show active" id="tab01" role="tabpanel" aria-labelledby="my-profile">
                 ...
                 <h5 class="pb-4"><a href="#" class="text-dark">Status</a> <span class="text-secondary">- @if(isset($profile[0]['confirm']))
                     ...
                     @else
                     <span  style="color:green"><i class="fas fa-check mr-3"></i>confirm</span>
                     @endif
                     @endif</span>
                 </h5>
             </div>
